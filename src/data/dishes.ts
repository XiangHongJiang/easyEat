...
/** Emoji 品类 */
export type EmojiCategory = '蔬菜' | '肉类' | '水产' | '水果' | '面点' | '饮品' | '其他';
...
export const BUILT_IN_DISHES: Dish[] = [
  ...
  { id: 'b012', name: '麻辣香锅', mealType: '午餐', cuisine: '中餐', emoji: '🌶️', description: '麻辣鲜香，想吃什么夹什么', builtIn: true },
...
/** 按食材品类分类的可选 emoji 列表（添加菜品时用） */
export const EMOJI_OPTIONS_BY_CATEGORY: Record<EmojiCategory, string[]> = {
  蔬菜: [
    '🍅', '🥬', '🥒', '🍆', '🫑', '🌶️', '🧄', '🧅', '🥕', '🫒',
    '🥔', '🍠', '🌽', '🥦', '🍄', '🫛', '🥗', '🧆',
  ],
